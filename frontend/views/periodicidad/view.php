...
$this->title = $model->idperiodicidad;
...
<div class="periodicidad-view">
    ...
    <tr>
    <h1 style="font-family:Impact;">Periodicidad</h1>
    </tr>
    <br>
...
<div role="navigation" class="navbar navbar-inverse navbar-static-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="#" class="navbar-brand">Sistema Programa Presupuestal</a> </div>
...
<div class="container">
  <div class="row">
    <h4>Favor de cargar sus medios de verificación ya que son de suma importancia</h4>
    <hr style="margin-top:5px;margin-bottom: 5px;">
    <div class="content"> </div>
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">Cargar medios de Verificación</h3>
      </div>
